...
export const defaultSchedule: ScheduleState = {
  ...
  halls: [
    ...
    },
    {
      ...
      dayClosures: {},
      days: {
        'מוצ״ש': [{ s: '20:00', e: '22:30', sport: '🏀', title: 'כדורסל חברי קיבוץ' }],
        'ראשון': [{ s: '20:00', e: '22:30', sport: '🏀', title: 'כדורסל בוגרים (שי)' }],
        'שני': [{ s: '20:00', e: '22:30', sport: '🏐', title: 'כדורשת' }],
        'שלישי': [
          { s: '14:00', e: '15:30', sport: '🏀', title: 'ילדי הקיבוץ' },
          { s: '16:00', e: '19:00', sport: '🏀', title: 'כדורסל ילדים- מיקו' },
        ],
        'רביעי': [
          { s: '16:00', e: '19:00', sport: '🏀', title: 'כדורסל ילדים- מיקו' },
          { s: '20:00', e: '22:30', sport: '🏀', title: 'כדורסל בוגרים (שי)' },
        ],
        'חמישי': [{ s: '16:00', e: '19:00', sport: '🏀', title: 'כדורסל ילדים- מיקו' }],
      },
    },
  ],
};
